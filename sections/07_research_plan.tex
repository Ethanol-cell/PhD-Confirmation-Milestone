...
structure
& Adaptive-$K$ multi-architecture localization; held-out and prospective
ImageNet-S cohorts; exact distance decomposition; prospective RANDOM64
geometry-preservation control; localization, AUPRC, and faithfulness
non-inferiority across six CNN architectures
& Supported for class-agnostic object-relevant localization in the tested CNN
families. Mechanistic evidence supports a redundant prototype-relative
Euclidean geometry, and RAW Adaptive K-DGRP remains canonical. External-domain
and target-class attribution claims remain separate.\\
\thinrowrule
...
\textbf{K-DGRP's CNN mechanism is sufficiently characterized for this milestone
report.} The remaining K-DGRP work should concentrate on publication packaging,
external-domain generalization, any sanity or class-sensitivity controls that
remain open, and a fixed qualitative error atlas. It should not continue an
unbounded search over PCA, radius, common-gain, or residual scoring formulas.
The J1 paper still requires replication of the strongest external baselines,
an uncertainty-aware J1--ReviewKD comparison, resource-cost reporting, and a
